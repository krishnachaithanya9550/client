...
//   async ({ courseId, phoneNumber, paymentMethod }, { rejectWithValue }) => {
//     try {
//       return await enrollmentService.enroll({ courseId, phoneNumber, paymentMethod });
//     } catch (error) {
...
// export const enrollCourse = createAsyncThunk(
//   "enrollment/enrollCourse",
//   async ({ courseId, courseTitle, phoneNumber, paymentMethod }, { rejectWithValue }) => {
//     try {
//       return await enrollmentService.enroll({ courseId, courseTitle, phoneNumber, paymentMethod });
//     } catch (error) {
//       return rejectWithValue(error.message);
//     }
//   }
